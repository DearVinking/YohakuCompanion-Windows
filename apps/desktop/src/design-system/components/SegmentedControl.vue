...
<template>
  ...
  >
    <div
      v-if="indicator"
      class="pointer-events-none absolute inset-y-0 left-0 rounded-lg border border-white/60 bg-[rgba(0,0,0,0.098)] shadow-[0_0_35px_rgba(0,0,0,0.15)] dark:border-white/20 dark:bg-[rgba(255,255,255,0.098)]"
      :class="[
        disabled ? 'opacity-45' : '',
        indicatorAnimated
