...
mod tests {
    ...
    fn date_parse_strict() {
        ...
        assert_eq!(parse_rfc3339_millis("2026-01-02T03:04:05Z"), None);
        assert_eq!(parse_rfc3339_millis("2026-01-02T03:04:05.007000Z"), None);
        assert_eq!(parse_rfc3339_millis("2026-01-02T03:04:05.007+08:00"), None);
        assert_eq!(parse_rfc3339_millis("not-a-date"), None);
        assert_eq!(parse_rfc3339_millis("2026-13-02T03:04:05.007Z"), None);
    }
}
